...
- (void)defaultNavigationBar{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor] opaque:YES size:CGSizeMake([UIScreen mainScreen].bounds.size.width, 66)] forBarMetrics:UIBarMetricsDefault];
